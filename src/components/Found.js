...
const Found = ({keyword,getData2,setisKeyword}) => {
            ...
            <div id='body'>
                <div>
                    ...
                    <div className="text">
                        ...
                        <h3>No news articles found for '{keyword}'.</h3>
                        <h3>Try searching something else!</h3>
                        <button  onClick={()=>{
                            setisKeyword(true);
                            getData2();
                        }}><Link style={{ display: 'block',fontSize:'1.75rem' }} to="/"  >BACK</Link></button>
                    </div>
                </div>
            </div>
